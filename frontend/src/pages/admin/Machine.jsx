...
export default function MachineManagement() {
  ...
  const handleDelete = async (id, name) => {
    ...
    try {
      await fetch(`https://blackpear-backend.vercel.app/api/machines/${id}`, { 
        method: "DELETE" 
      });
      fetchMachines();
    } catch (err) {
  ...
  const handleSubmit = async (event) => {
    ...
    const url = isEdit 
      ? `https://blackpear-backend.vercel.app/api/machines/${editingMachine.id}` 
      : "https://blackpear-backend.vercel.app/api/machines";
