      ...
      {filteredMachines.length > 0 ? (
        ...
        <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
          ...
          {filteredMachines.map((machine) => {
            ...
            return (
              <div
                key={machine.id}
                className={`rounded-2xl border bg-[#121620] p-6 transition hover:bg-[#151A24] ${
                  config.border
                }`}
              >
                ...
                <div className="mb-6 flex items-start justify-between">
                  ...
                  <div
                    className={`flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-semibold ${config.bg} ${config.color}`}
                  >
        ...
        <div className="rounded-2xl border border-[#1F2937] bg-[#121620] p-12 text-center">
          ...
          <p className="mt-2 text-sm text-[#8B95A7]">
            Tidak ada mesin yang sesuai dengan filter atau pencarian.
          </p>
...
function FilterButton({
  ...
  const colorConfig = {
    ...
    yellow: {
      active: "bg-[#F59E0B]/10 text-[#F59E0B] border-[#F59E0B]/30",
    },
    red: {
      active: "bg-[#EF4444]/10 text-[#EF4444] border-[#EF4444]/30",
    },
  };
